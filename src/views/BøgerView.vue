<template>
    <div class="bøger_container">
        
        <div class="bøger_innercontainer_top">
            <h1>Bøger</h1>
            <p>Her kan du se vores bøger</p>
        </div>
        ...
        <div class="view_innercontainer_bottom flex grid grid-cols-4 mt-10">
            <template v-for="produkt in produkter" :key="produkt">
                <div v-if="produkt.produktKategori == 'Bøger'">
