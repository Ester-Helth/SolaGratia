<template>
    <div class="køkken_container">
        
        <div class="køkken_innercontainer_top">
            <h1>Køkken</h1>
            <p>Her kan du se køkkenkollektionen</p>
        </div>
        ...
        <div class="view_innercontainer_bottom flex grid grid-cols-4 mt-10">
            <template v-for="produkt in produkter" :key="produkt">
                <div v-if="produkt.produktKategori == 'Køkken'">
